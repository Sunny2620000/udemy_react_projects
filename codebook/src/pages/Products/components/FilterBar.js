import { useFilter } from "../../../context/ContextIndex"
                ...
                <div className="py-4 overflow-y-auto">
                    <ul className="text-slate-700 dark:text-slate-100">
                        ...
                        <li className="mt-1 mb-5">
                            ...
                            <div className="flex items-center my-1">
                                <input id="rating-sort-1" type="radio" onChange={() => dispatch({ type: "RATING", payload: { rating: "4STARABOVE" } })} checked={state.rating === "4STARABOVE" || false} name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                                <label htmlFor="rating-sort-1" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">4 Stars & Above</label>
                            </div>
                            <div className="flex items-center my-1">
                                <input id="rating-sort-2" type="radio" onChange={() => dispatch({ type: "RATING", payload: { rating: "3STARABOVE" } })} checked={state.rating === "3STARABOVE" || false} name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                                <label htmlFor="rating-sort-2" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">3 Stars & Above</label>
                            </div>
                            <div className="flex items-center my-1">
                                <input id="rating-sort-3" type="radio" onChange={() => dispatch({ type: "RATING", payload: { rating: "2STARABOVE" } })} checked={state.rating === "2STARABOVE" || false} name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                                <label htmlFor="rating-sort-3" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">2 Stars & Above</label>
                            </div>
                            <div className="flex items-center my-1">
                                <input id="rating-sort-4" type="radio" onChange={() => dispatch({ type: "RATING", payload: { rating: "1STARABOVE" } })} checked={state.rating === "1STARABOVE" || false} name="rating-sort" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                        ...
                        <li className="mt-1 mb-5">
                            ...
                            <div className="flex items-center my-1">
                                <input onChange={() => dispatch({ type: "BEST_SELLER_ONLY", payload: { bestSellerOnly: !state.bestSellerOnly } })} id="best-seller" type="checkbox" checked={state.bestSellerOnly || false} className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
                                <label htmlFor="best-seller" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Best Seller Only</label>
                            </div>
                            <div className="flex items-center my-1">
                                <input onChange={() => dispatch({ type: "IN_STOCK", payload: { onlyInStock: !state.onlyInStock } })} id="only-instock" type="checkbox" checked={state.onlyInStock || false} className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
